...
function Intro() {
    ...
    const data = [ 
        ...
        {title: 'Digital Assets' , des: 'Non-Fungible Token หรือ NFT คือ Token ที่นำเทคโนโลยี Blockchain มาใช้ ทำให้สามารถแสดงความเป็นเจ้าของของสินทรัพย์นั้นๆ ได้ โดยแต่ละ Token จะแตกต่างกัน เช่น การ์ดเกม งานศิลปะ ของสะสม สามารถนำสินทรัพย์ที่มีความ Unique, Rare, Indivisible มาทำ Token ได้', img: Intro3},
